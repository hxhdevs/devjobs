<form class="md:w-1/2 space-y-5" wire:submit.prevent='crearVacante'>
    ...
    <div>
        ...
        <x-text-input
                ...
                class="rounded-md shadow-sm border-gray-300 focus:border-gray-300 focus:ring focus:ring-gray-200 focus:ring-opacity-50 w-full h-72"
                />
                @error('descripcion')
                    <livewire:mostrar-alerta :message="$message">
                @enderror
